    ...
    <section className="w-[90%] m-auto">
      <div className="flex my-6 justify-center items-center">
        <div className="w-[50%]">
          ...
          <p>
            ...
            effective education counselling. We work on your behalf as an
      ...
      <div className="flex mb-9 justify-center items-center">
        ...
        <div className="w-[50%] flex flex-col gap-3 items-start">
          <h2 className="text-2xl">Our experience and partnerships will help you go a long way</h2>
          <p>
          ...
          <img
            ...
            alt="" className="w-1/2"
          />
          <button className="rounded-3xl bg-primary text-white px-3 py-2">SPEAK WITH US TODAY</button>
        </div>
      </div>
    </section>
  );
