...
export const ExploreSearch = () => {
  return (
    <div className="pt-16 mb-6 font-bold frame bg-[#f4f5fb]">
      <h1 className="text-2xl w-[90%] m-auto p-6">
        Explore courses that match your career{" "}
        <span className="block">aspirations </span>
      </h1>

      <form className="w-[90%] shadow-xl bg-white m-auto my-2 flex max-md:flex-col gap-4  p-5 rounded-xl ">
        ...
        <label htmlFor="" className="w-full relative">
          <FaLocationDot className="absolute top-4 left-3 max-md:right-0 max-md:" />
          <input
            type="text"
