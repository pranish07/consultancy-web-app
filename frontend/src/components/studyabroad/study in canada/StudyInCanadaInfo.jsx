...
export const StudyInCanadaInfo = () => {
  return (
    <div className=" ">
    ...
    <div className="large:flex w-[90%] m-auto my-9 gap-6">
      <div className="large:w-[70%]">
        <div className="">
          ...
          <p>
          Canada is a contemporary, democratic nation with excellent
            healthcare, top-notch educational institutions, and a unique
            geography. Studying in Canada is particularly a terrific option
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full table-auto">
                ...
                <tbody className="text-normal">
                  {studyAbroadData?.studyInCanada?.studyInCanadaFromNepal?.keyFacts?.tableData?.map(
                    ({ title, desc }, idx) => {
                      return (
        ...
        <div>
          <div>
            ...
            {studyAbroadData.studyInCanada.benefitsOfStudyingInCanada.information.map(
              ({ title, desc }, idx) => {
                return (
        ...
        <div>
          <div>
            ...
            <small>
              ...
              education consultancy in Nepal for Canada!
            </small>
        ...
        <div>
          ...
          <p>
          Canada is home to several top-ranked universities that offer
        ...
        <div>
          ...
          <p>
            To understand how to study in Canada, you must also understand
            the admission requirements for different courses in Canada:
          </p>
          <div>
        ...
        <div>
          <div className="join join-vertical w-full bg-green">
            ...
            {studyAbroadData.studyInCanada.FAQ.map(({ title, content }, idx) => {
              return (
                <div
