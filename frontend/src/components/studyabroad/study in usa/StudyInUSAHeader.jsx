...
export const StudyInUSAHeader = () => {
  return (
    ...
    <h1 className="text-3xl font-bold text-primary">Your dream of studying in USA is closer than you think!</h1>
    <p className="">
      Learn everything you need to know about studying in USA and get
